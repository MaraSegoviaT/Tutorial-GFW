...
MMSI_01_01_2020 <- read.csv('D:\\SML\\GFW\\GFW Descargable\\Download 2020\\MMSI_2012-2020\\mmsi-daily-csvs-10-v2-2020\\2020-08-01.csv')
...
#IGUAL ESTOY HACIENDO EL TONTO Y NO HAY INTERSECCIONES?? EFECTIVAMENTE
...
if (nrow(intersecciones) > 0) {
  ...
  MMSI_01_01_2020_cabrera <- st_sf()
}

# Mostrar la estructura del resultado
#str(MMSI_01_01_2020_cabrera)
