...
carpeta_datos_2020 <- 'D:\\SML\\GFW\\GFW Descargable\\Download 2020\\MMSI_2012-2020\\mmsi-daily-csvs-10-v2-2020'



#Obten la lista de archivos CSV en la carpeta principal y sus subcarpetas
archivos_mmsi_csv_2020 <- list.files(path = carpeta_datos_2020, pattern = "\\.csv$", recursive = TRUE, full.names = TRUE)

#Inicia una lista para almacenar los resultados de cada archivo
MMSI_Cabrera_2020 <- list()

#Bucle para procesar cada archivo CSV
for (archivo_csv in archivos_mmsi_csv_2020) {
...
MMSI_Cabrera_2020_comb <- do.call(rbind, MMSI_Cabrera_2020)
